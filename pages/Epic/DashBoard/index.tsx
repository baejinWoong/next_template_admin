...
import { getDashboard } from 'api/epicApi'
...
interface I_dashBoardData {
  ...
  retention: {
    [index: string]: Array<{ n: number; statisticsDay: string; userActiveCnt: number; userRetentionCnt: number }>
  }
}
...
const Index = () => {
  ...
  const [data, setData] = React.useState<I_dashBoardData>({
    ...
    retention: { [`${moment(TARGETDATE).subtract(LABELDAYS, 'day').format('YYYY-MM-DD')}`]: [] },
  })
  ...
  const chartData = () => {
    const datasets = Object.keys(data.retention).map((keys) => {
      ...
      return {
        label: keys,
        data: data.retention[keys].map((data) => Math.floor((data.userActiveCnt / data.userRetentionCnt) * 100)),
        borderColor: color,
            ...
            <Grid type="container" style={{ height: '100%', minHeight: '400px', alignContent: 'space-between' }}>
                ...
                <Card style={{ padding: '0', boxShadow: 'rgba(91, 71, 188, 0.3) 0px 0px 11px 0px' }}>
                  ...
                  >
                    <Grid type="item" area={12} align="center" color="purple" colorWeight="200" style={{ padding: '12px' }}>
                      <Typography fontSize="body2">실시간 가입자수(Epic)</Typography>
                    </Grid>
                    <Grid type="item" area={12} align="center" color="purple" colorWeight="200" style={{ padding: '12px' }}>
                      <Typography fontSize="body2">시간당 평균 가입자 수(Epic)</Typography>
                    </Grid>
              ...
              <Grid type="item">
                ...
                <Card style={{ padding: '0', boxShadow: 'rgba(91, 71, 188, 0.3) 0px 0px 11px 0px' }}>
                  <Grid type="container">
                    <Grid type="item" area={12} align="center" color="purple" colorWeight="200" style={{ padding: '12px' }}>
                      <Typography fontSize="body2">실시간 매출(Epic)</Typography>
                    </Grid>
                    <Grid type="item" area={12} align="center" color="purple" colorWeight="200" style={{ padding: '12px' }}>
                      <Typography fontSize="body2">시간당 평균 매출(Epic)</Typography>
                    </Grid>
                    <Grid type="item" area={12} align="center" style={{ padding: '30px 12px' }}>
